...
export const ProposalListItem = ({
  ...
  return (
    <div
      key={index}
      className="relative flex flex-col space-y-10 p-6 cursor-pointer bg-cards bg-opacity-75 rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700"
