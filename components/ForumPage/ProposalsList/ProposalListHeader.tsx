...
export function ProposalListHeader(props: any) {
  return (
    <div className="p-6 basis-1/4 h-fit bg-cards bg-opacity-90 rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
      <div>
        <h5 className="mb-2 min-h-max text-2xl font-bold tracking-tight text-textPrimary dark:text-white">
