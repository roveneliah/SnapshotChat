...
const buttonStyle = {
    ...
    purple: "inline-flex items-center max-w-fit py-2 px-3 text-sm font-medium text-center text-purple-900 bg-purple-300 rounded-lg hover:bg-purple-400 focus:ring-4 focus:ring-purple-300 dark:bg-purple-200 dark:hover:bg-purple-300 dark:focus:ring-purple-200",
