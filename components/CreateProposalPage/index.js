...
import { createProposal } from "../../utils/firestore";
...
export default function CreateProposalPage(props) {
  ...
  return (
    <div className="flex flex-row justify-center">
      <div className="flex flex-row w-full px-3 space-x-3 justify-center">
        {ProposalForm({
          ...props,
          title,
          setTitle,
        ...
        <div className="flex flex-col space-y-10 w-2/3 p-6 bg-white rounded-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
